...
namespace RubiksCubeTrainer.Puzzle3x3
{
    partial struct Location
    {
		...
		public static Location DownLeftFront { get; } = new Location(FaceName.Down, -1, -1, -1);
		public static Location DownRightFront { get; } = new Location(FaceName.Down, 1, -1, -1);
		...
		public static Location DownLeftBack { get; } = new Location(FaceName.Down, -1, 1, -1);
		public static Location DownRightBack { get; } = new Location(FaceName.Down, 1, 1, -1);
		...
		public static Location UpLeftBack { get; } = new Location(FaceName.Up, -1, 1, 1);
		public static Location UpRightBack { get; } = new Location(FaceName.Up, 1, 1, 1);
		public static Location UpFront { get; } = new Location(FaceName.Up, 0, -1, 1);
		public static Location UpLeftFront { get; } = new Location(FaceName.Up, -1, -1, 1);
		public static Location UpRightFront { get; } = new Location(FaceName.Up, 1, -1, 1);
	...
	public static class LocationParser
	{
		public static Location Parse(string location)
		{
			...
			if ("DownLeftFront".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.DownLeftFront;
			if ("DownRightFront".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.DownRightFront;
			...
			if ("DownLeftBack".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.DownLeftBack;
			if ("DownRightBack".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.DownRightBack;
			...
			if ("UpLeftBack".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.UpLeftBack;
			if ("UpRightBack".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.UpRightBack;
			if ("UpFront".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.UpFront;
			if ("UpLeftFront".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.UpLeftFront;
			if ("UpRightFront".Equals(location, StringComparison.OrdinalIgnoreCase)) return Location.UpRightFront;
		...
		public static string Format(Location location)
		{
			...
			if (location == Location.DownLeftFront) return "DownLeftFront";
			if (location == Location.DownRightFront) return "DownRightFront";
			...
			if (location == Location.DownLeftBack) return "DownLeftBack";
			if (location == Location.DownRightBack) return "DownRightBack";
			...
			if (location == Location.UpLeftBack) return "UpLeftBack";
			if (location == Location.UpRightBack) return "UpRightBack";
			if (location == Location.UpFront) return "UpFront";
			if (location == Location.UpLeftFront) return "UpLeftFront";
			if (location == Location.UpRightFront) return "UpRightFront";
