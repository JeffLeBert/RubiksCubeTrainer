    ...
    public static class StepParser
    {
        public static Step Parse(XElement stepElement, Solver solver)
            => new Step(
                ...
                PuzzleStateParser.Parse(stepElement.Element(nameof(Step.InitialState)), solver),
                PuzzleStateParser.Parse(stepElement.Element(nameof(Step.FinishedState)), solver),
